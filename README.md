...
This FORK was created by @gromakovsky.
We use it whenever we want to make changes to `build-constraints.yaml` because this file defines what goes into Stackage snapshots.
